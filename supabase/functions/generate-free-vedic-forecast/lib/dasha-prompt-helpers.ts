// Dasha prompt helper functions for LLM input construction
// supabase/functions/generate-free-vedic-forecast/lib/dasha-prompt-helpers.ts
...
/**
 * Format current dasha for prompt
 */
