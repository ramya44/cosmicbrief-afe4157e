...
const HastaNakshatraPage = () => {
  return (
    <NakshatraPageTemplate
      name="Hasta"
      title="Hasta Nakshatra: The Divine Hand of Creation"
      seoTitle="Hasta Nakshatra: The Divine Hand of Creation | Cosmic Brief"
      metaDescription="Discover Hasta nakshatra, the star of skillful hands and divine craftsmanship in Vedic astrology. Learn about its dexterity, humor, and manifestation power."
      slug="hasta-nakshatra"
      readTime="9 min read"
      authorDate="February 3, 2025"
      quickFacts={[
        { label: "Position", value: "10°00' to 23°20' Virgo" },
        { label: "Ruling Planet", value: "Moon (Chandra)" },
        { label: "Deity", value: "Savitar (Sun God as Divine Creator)" },
        { label: "Symbol", value: "Open hand, palm, fist" },
        { label: "Element", value: "Fire" },
        { label: "Quality", value: "Light, swift" },
        { label: "Power", value: "Hasta Sthapaniya Agama Shakti (power to manifest what you seek)" },
      ]}
      jsonLd={{
        ...
        url: "https://www.cosmicbrief.com/blog/hasta-nakshatra",
      }}
      ctaDescription="Discover your Moon nakshatra and see how Hasta's skillful creative energy influences your chart."
      relatedPosts={[
        { href: "/blog/uttara-phalguni-nakshatra", text: "Uttara Phalguni Nakshatra: The Pillar of Noble Service" },
        { href: "/blog/pushya-nakshatra", text: "Pushya Nakshatra: The Nourishing Star" },
