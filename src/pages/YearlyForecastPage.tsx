...
const YearlyForecastPage = () => {
  ...
  }, [kundliId, freeForecast, isLoading, isAuthenticated, hasKundli, kundli, navigate, setBirthData, setKundliId, setFreeForecast]);
    ...
    <div className="relative min-h-screen bg-celestial overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-16">
        <div className="text-center max-w-3xl mx-auto">
          ...
          {/* Weekly upsell */}
          <p className="mt-8 text-sm text-cream-muted animate-fade-up" style={{
            animationDelay: '400ms',
            animationFillMode: 'both'
          }}>
            Want weekly insights?{' '}
            <a href="/" className="text-gold hover:underline">
              Try our weekly forecast
            </a>
          </p>

          {/* Subtle footer text */}
          <p className="mt-12 text-base text-muted-foreground font-sans animate-fade-up" style={{
