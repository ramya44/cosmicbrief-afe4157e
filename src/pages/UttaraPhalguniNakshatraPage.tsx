...
const UttaraPhalguniNakshatraPage = () => {
  return (
    <NakshatraPageTemplate
      ...
      title="Uttara Phalguni Nakshatra: The Pillar of Noble Service"
      seoTitle="Uttara Phalguni Nakshatra: The Pillar of Noble Service | Cosmic Brief"
      metaDescription="Explore Uttara Phalguni nakshatra, the star of commitment, service, and noble partnerships in Vedic astrology. Discover its leadership qualities and generous spirit."
      slug="uttara-phalguni-nakshatra"
      readTime="10 min read"
      authorDate="February 3, 2025"
      quickFacts={[
        { label: "Position", value: "26°40' Leo to 10°00' Virgo" },
        { label: "Ruling Planet", value: "Sun (Surya)" },
        { label: "Deity", value: "Aryaman (God of Contracts, Partnerships, Honor)" },
        { label: "Symbol", value: "Back legs of bed, four legs of cot" },
        { label: "Element", value: "Fire" },
        { label: "Quality", value: "Fixed, stable" },
        { label: "Pair", value: "Forms a pair with Purva Phalguni" },
      ]}
      jsonLd={{
        ...
        url: "https://www.cosmicbrief.com/blog/uttara-phalguni-nakshatra",
      }}
      ctaDescription="Discover your Moon nakshatra and see how Uttara Phalguni's service-oriented partnership energy influences your chart."
      relatedPosts={[
