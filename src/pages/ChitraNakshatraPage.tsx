...
const ChitraNakshatraPage = () => {
  return (
    <NakshatraPageTemplate
      name="Chitra"
      title="Chitra Nakshatra: The Jewel of Creation"
      seoTitle="Chitra Nakshatra: The Jewel of Creation | Cosmic Brief"
      metaDescription="Explore Chitra nakshatra, the brilliant star of artistry and creation in Vedic astrology. Discover its visionary power, aesthetic genius, and architectural mastery."
      slug="chitra-nakshatra"
      readTime="10 min read"
      authorDate="February 8, 2025"
      quickFacts={[
        { label: "Position", value: "23°20' Virgo to 6°40' Libra" },
        { label: "Ruling Planet", value: "Mars (Mangal)" },
        { label: "Deity", value: "Vishwakarma (Divine Architect)" },
        { label: "Symbol", value: "Pearl, bright jewel, shining light" },
        { label: "Element", value: "Fire" },
        { label: "Quality", value: "Soft, tender" },
        { label: "Western Star", value: "Spica (brightest in Virgo)" },
        { label: "Power", value: "Punya Cayani Shakti (power to accumulate merit)" },
      ]}
      jsonLd={{
        ...
        url: "https://www.cosmicbrief.com/blog/chitra-nakshatra",
      }}
      ctaDescription="Discover your Moon nakshatra and see how Chitra's visionary creative energy influences your chart."
      relatedPosts={[
        { href: "/blog/hasta-nakshatra", text: "Hasta Nakshatra: The Divine Hand of Creation" },
        { href: "/blog/purva-phalguni-nakshatra", text: "Purva Phalguni Nakshatra: The Star of Creative Delight" },
