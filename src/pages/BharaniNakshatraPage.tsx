...
const BharaniNakshatraPage = () => (
  <NakshatraPageTemplate
    ...
    seoTitle="Bharani Nakshatra: The Cosmic Womb of Transformation | Cosmic Brief"
    metaDescription="Discover Bharani nakshatra, the second lunar mansion in Vedic astrology. Learn about its transformative power, connection to life and death, and how it shapes destiny."
    slug="bharani-nakshatra"
    readTime="7 min read"
    authorDate="January 26, 2025"
    quickFacts={[
      { label: "Position", value: "13°20' to 26°40' Aries" },
      { label: "Ruling Planet", value: "Venus (Shukra)" },
      { label: "Deity", value: "Yama (Lord of Death)" },
      { label: "Symbol", value: "Yoni (female organ)" },
      { label: "Element", value: "Earth" },
      { label: "Quality", value: "Fierce, severe" },
    ]}
    jsonLd={{
      ...
      url: "https://www.cosmicbrief.com/blog/bharani-nakshatra",
    }}
    relatedPosts={[
      { href: "/blog/ashwini-nakshatra", text: "Ashwini Nakshatra: The Divine Healers" },
      { href: "/blog/what-is-nakshatra", text: "Nakshatra: Your True Cosmic DNA" },
    ]}
    ctaDescription="Discover your Moon nakshatra and see how Bharani's transformative energy influences your chart."
  >
