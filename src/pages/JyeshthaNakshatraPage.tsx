...
const JyeshthaNakshatraPage = () => {
  return (
    <NakshatraPageTemplate
      name="Jyeshtha"
      title="Jyeshtha Nakshatra: The Eldest Star"
      seoTitle="Jyeshtha Nakshatra: The Star of Seniority and Protection | Cosmic Brief"
      metaDescription="Discover Jyeshtha nakshatra, the star of authority, protection, and earned power in Vedic astrology. Learn about its leadership qualities and protective nature."
      slug="jyeshtha-nakshatra"
      readTime="14 min read"
      authorDate="February 24, 2026"
      quickFacts={[
        { label: "Position", value: "16°40' to 30°00' Scorpio" },
        { label: "Ruling Planet", value: "Mercury (Budha)" },
        { label: "Deity", value: "Indra (King of Gods)" },
        { label: "Symbol", value: "Earring, circular amulet, umbrella" },
        { label: "Element", value: "Air" },
        { label: "Quality", value: "Sharp, fierce" },
        { label: "Western Star", value: "Antares (Heart of the Scorpion)" },
        { label: "Power", value: "To rise and conquer" },
      ]}
      showGoDeeper={false}
      showFooterTagline={false}
      ctaTitle="Discover Your Nakshatra"
      ctaDescription="Jyeshtha is just one of 27 lunar mansions. Uncover which nakshatra shapes your destiny and what it reveals about your life path."
    >
      {/* The Meaning */}
