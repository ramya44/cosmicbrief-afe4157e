...
import { Sparkles, LogIn, Menu, Calendar, Circle } from 'lucide-react';
...
// Secondary nav items shown in hamburger menu on mobile, full nav on desktop
...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-celestial overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 hidden md:flex items-center justify-between px-4 md:px-8 py-4">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 flex md:hidden items-center justify-end px-4 py-4">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-16 pb-24 md:pb-16">
      ...
      {/* Bottom gradient fade - adjusted for mobile nav */}
      <div className="absolute bottom-0 left-0 right-0 h-32 md:h-32 bg-gradient-to-t from-midnight to-transparent pointer-events-none" />

      {/* Mobile Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-30 md:hidden bg-midnight/95 backdrop-blur-lg border-t border-gold/20">
